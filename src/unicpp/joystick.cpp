...
Pos2<S2> g_gampStickPosRaw[2];

dfa GampStickState::GampStickState() : posRaw(0, 0), len(0), angle(0)
{
}
...
dfa ER _GampStateUpd()
{
    ...
    g_gampKeyState[U1(InputKey::GAMP_UP)] = U1((state.Gamepad.wButtons & XINPUT_GAMEPAD_DPAD_UP) ? 0x80 : 0x00);
    g_gampKeyState[U1(InputKey::GAMP_DOWN)] = U1((state.Gamepad.wButtons & XINPUT_GAMEPAD_DPAD_DOWN) ? 0x80 : 0x00);
    g_gampKeyState[U1(InputKey::GAMP_LEFT)] = U1((state.Gamepad.wButtons & XINPUT_GAMEPAD_DPAD_LEFT) ? 0x80 : 0x00);
    g_gampKeyState[U1(InputKey::GAMP_RIGHT)] = U1((state.Gamepad.wButtons & XINPUT_GAMEPAD_DPAD_RIGHT) ? 0x80 : 0x00);
    g_gampKeyState[U1(InputKey::GAMP_MENU)] = U1((state.Gamepad.wButtons & XINPUT_GAMEPAD_START) ? 0x80 : 0x00);
    g_gampKeyState[U1(InputKey::GAMP_VIEW)] = U1((state.Gamepad.wButtons & XINPUT_GAMEPAD_BACK) ? 0x80 : 0x00);
    g_gampKeyState[U1(InputKey::GAMP_L3)] = U1((state.Gamepad.wButtons & XINPUT_GAMEPAD_LEFT_THUMB) ? 0x80 : 0x00);
    g_gampKeyState[U1(InputKey::GAMP_R3)] = U1((state.Gamepad.wButtons & XINPUT_GAMEPAD_RIGHT_THUMB) ? 0x80 : 0x00);
    g_gampKeyState[U1(InputKey::GAMP_LB)] = U1((state.Gamepad.wButtons & XINPUT_GAMEPAD_LEFT_SHOULDER) ? 0x80 : 0x00);
    g_gampKeyState[U1(InputKey::GAMP_RB)] = U1((state.Gamepad.wButtons & XINPUT_GAMEPAD_RIGHT_SHOULDER) ? 0x80 : 0x00);
    g_gampKeyState[U1(InputKey::GAMP_A)] = U1((state.Gamepad.wButtons & XINPUT_GAMEPAD_A) ? 0x80 : 0x00);
    g_gampKeyState[U1(InputKey::GAMP_B)] = U1((state.Gamepad.wButtons & XINPUT_GAMEPAD_B) ? 0x80 : 0x00);
    g_gampKeyState[U1(InputKey::GAMP_X)] = U1((state.Gamepad.wButtons & XINPUT_GAMEPAD_X) ? 0x80 : 0x00);
    g_gampKeyState[U1(InputKey::GAMP_Y)] = U1((state.Gamepad.wButtons & XINPUT_GAMEPAD_Y) ? 0x80 : 0x00);
...
dfa BO GampKeyIsDownTake(InputKey key, BO isDownReq)
{
