...
inl cxex U8 g_sha512Round[80] = {0x428a2f98d728ae22, 0x7137449123ef65cd, 0xb5c0fbcfec4d3b2f, 0xe9b5dba58189dbbc, 0x3956c25bf348b538, 0x59f111f1b605d019, 0x923f82a4af194f9b, 0xab1c5ed5da6d8118,
...
struct Sha512Block : DatBlock<128>
{
};
struct Sha512Hash : DatBlock<64>
{
};
...
class Sha512Hasher
{
  ...
  public:
    dfa NT Begin();
    dfa NT Block(cx Sha512Block& bufBlock);
    dfa NT End(CXGA buf, SI sizeSum);
    dfa NT Get(Sha512Hash& hash) cx;
};
