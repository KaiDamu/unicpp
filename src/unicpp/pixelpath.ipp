...
tpl1 dfa NT PixelPath::Build(ColGrid<T1>& colGrid, BitVec& pixelPath, cx T1& colObj, cx T1& colMark, BuildStrat strat)
{
    struct DirLen
    {
        Dir dir;
...
tpl1 dfa NT PixelPath::Draw(ColGrid<T1>& colGrid, cx BitVec& pixelPath, cx T1& col)
{
    U4 varU4;
    SI posMain = -1;
    AU pxPathCurb = 0;
