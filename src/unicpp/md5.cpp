...
dfa cx U1* Md5::Val::B1() cx
{
    ret b1;
}
dfa cx U2* Md5::Val::B2() cx
{
    ret b2;
}
dfa cx U4* Md5::Val::B4() cx
{
    ret b4;
}
dfa cx U8* Md5::Val::B8() cx
{
    ret b8;
}
dfa NT Md5::Val::GetCsstr(CS* str) cx
{
...
dfa NT Md5::Val::SetCsstr(cx CS* str)
{
...
dfa NT Md5::Val::operator=(cx U1* val)
{
    MemCpy(tx, val, siz(*tx));
}
dfa Md5::Val::operator U1*()
{
    ret b1;
}
dfa Md5::Val::operator U2*()
{
    ret b2;
}
dfa Md5::Val::operator U4*()
{
    ret b4;
}
dfa Md5::Val::operator U8*()
{
    ret b8;
}
dfa BO Md5::Val::operator==(cx Val& val) cx
{
...
dfa Md5::Val::Val(cx CS* str)
{
    tx->SetCsstr(str);
}
dfa Md5::Val::Val(cx CH* str)
{
    tx->SetChstr(str);
}

dfa NT Md5::Gen::Round1(U4& s1, U4 s2, U4 s3, U4 s4, U4 b, U4 r, U4 a) cx
{
    s1 += ((s2 & s3) | (~s2 & s4)) + b + a;
    s1 = RotL(s1, r) + s2;
}
dfa NT Md5::Gen::Round2(U4& s1, U4 s2, U4 s3, U4 s4, U4 b, U4 r, U4 a) cx
{
    s1 += ((s2 & s4) | (s3 & ~s4)) + b + a;
    s1 = RotL(s1, r) + s2;
}
dfa NT Md5::Gen::Round3(U4& s1, U4 s2, U4 s3, U4 s4, U4 b, U4 r, U4 a) cx
{
    s1 += (s2 ^ s3 ^ s4) + b + a;
    s1 = RotL(s1, r) + s2;
}
dfa NT Md5::Gen::Round4(U4& s1, U4 s2, U4 s3, U4 s4, U4 b, U4 r, U4 a) cx
{
    s1 += (s3 ^ (s2 | ~s4)) + b + a;
    s1 = RotL(s1, r) + s2;
}

dfa NT Md5::Gen::Trans(cx U1* block)
{
    AU b = (cx U4*)block;
    AU s = m_state;
...
dfa NT Md5::Gen::Upd(cx U1* buf, SI bufSize)
{
    ifu (bufSize == 0)
        ret;
    if (m_isFinal)
...
dfa Md5::Val Md5::Gen::Get()
{
    tx->Final();
    ret m_state;
}
dfa NT Md5::Gen::GetCsstr(CS* str)
{
    tx->Get().GetCsstr(str);
}
...
dfa Md5::Val Md5::Get(cx U1* buf, SI bufSize)
{
    Gen gen;
    gen.Upd(buf, bufSize);
    ret gen.Get();
}
dfa NT Md5::GetCsstr(CS* str, cx U1* buf, SI bufSize)
{
