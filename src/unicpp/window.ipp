...
tpl1 dfa ER Win::_ColGridGetGdi(ColGrid<T1>& colGrid, CaptureMode captureMode)
{
    Cache::Gdi* cache;
...
tpl1 dfa ER Win::_ColGridGetDxgi(ColGrid<T1>& colGrid, CaptureMode captureMode)
{
    Cache::Dxgi* cache;
...
tpl1 dfa ER Win::ColGridGet(ColGrid<T1>& colGrid, CaptureMode captureMode)
{
    switch (captureMode)
    {
    case CaptureMode::GDI_WIN:
